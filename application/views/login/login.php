    ...
    <div class="bg-text">
        <section class="login_content">
            <form class="user validate-form" action="<?php echo base_url('login'); ?>" method="POST">
                <h1>Login Form</h1>
				<br><center><p>By <a>MA</a></p></center>
                ...
                <div class="separator">
                    ...
                    <div>
                        <h1><img style="width: 29px; height: 29px; border-radius: 50%; margin-right: 10px" src="<?= base_url('build/img/'); ?>logo-posyandu-1.png" alt=""></i>Posyandu Anak & Lansia</h1>
                        <span>Copyright &copy; Posyandu Anak & Lansia | By MA <?= date('Y'); ?></span>
                    </div>
                </div>
            </form>
        </section>
