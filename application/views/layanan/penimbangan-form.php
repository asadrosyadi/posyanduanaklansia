                ...
                <div class="x_content">
                    ...
                    <form id="penimbangan-form" name="penimbangan-form" class="form-horizontal form-label-left" action="<?php echo base_url('penimbangan_anak/submit'); ?>" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6 col-sm-6">
                                <div class="input-group">
                                    <input type="text" name="nik_anak" id="nik_anak" readonly="" class="form-control">
                                </div>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-md-6 col-sm-6">
                                <div class="input-group">
                                    <input type="text" name="kk_anak" id="kk_anak" readonly="" class="form-control">
                                </div>
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6 col-sm-6">
                                <div class="input-group">
                                    <input type="text" name="nama_orang_tua" id="nama_orang_tua" readonly="" class="form-control">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            <label class="col-form-label col-md-3 col-sm-3 label-align" for="tb">Lingkar Kepala [LK]
                            </label>
                            <div class="col-md-6 col-sm-6">
                                <input type=number step=any id="lingkar_kepala" name="lingkar_kepala" class="form-control">
                            </div>
                            <label class="col-form-label label-align" for="lingkar_kepala">cm
                            </label>
                        </div>
                        <div class="form-group row">
                            <label class="col-form-label col-md-3 col-sm-3 label-align" for="tb">Lingkar Lengan [LL]
                            </label>
                            <div class="col-md-6 col-sm-6">
                                <input type=number step=any id="lingkar_lengan" name="lingkar_lengan" class="form-control">
                            </div>
                            <label class="col-form-label label-align" for="lingkar_lengan">cm
                            </label>
                        </div>
                        <div class="form-group row">
                    ...
                    <tbody>
                        <?php foreach ($d_anak as $d) : ?>
                            <tr>
                                ...
                                <td>
                                    <button class="btnSelectAnak btn btn-primary btn-sm"
                                            data-id="<?= $d['id_anak']; ?>"
