                                    ...
                                    <tbody>
                                        ...
                                        <?php foreach ($lansia as $n) : ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <!-- <a data-toggle="modal" data-target="#viewDataLansiaModal<?= $n['id_lansia']; ?>" href="<?= base_url(); ?>lansia/viewDataLansia/<?= $n['id_lansia']; ?>" class="btn btn-info btn-circle btn-sm">
                                                        <i class="fa fa-sticky-note"></i>
                                                    </a> -->
                                                    <a data-toggle="tooltip" href="<?= base_url(''); ?>lansia/deleteDataLansia/<?= $n['id_lansia']; ?>" class="btn btn-danger btn-circle btn-sm tbl-hapus" title="Delete">
                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 form-group">
                                <div class="item form-group">
                                    <label class="col-form-label col-md-3 col-sm-3 label-align" for="nama-lansia">Nama Lansia</label>
                                    <div class="col-md-9">
                                        <input type="text" id="nama-lansia" name="nama-lansia" required="required" class="form-control">
                                    </div>
                                </div>
                                <div class="item form-group">
                                    <label class="col-form-label col-md-3 col-sm-3 label-align" for="nik-lansia">NIK Lansia</label>
                                    <div class="col-md-9">
                                        <input type="text" id="nik-lansia" name="nik-lansia" required="required" data-inputmask="'mask' : '9999999999999999'" class="form-control">
                                    </div>
                                </div>
                                <div class="item form-group">
                                    <label class="col-form-label col-md-3 col-sm-3 label-align" for="kk_lansia">No KK</label>
                                    <div class="col-md-9">
                                        <input type="text" id="kk_lansia" name="kk_lansia" required="required" data-inputmask="'mask' : '9999999999999999'" class="form-control">
                                    </div>
                                </div>
                                <div class="item form-group">
