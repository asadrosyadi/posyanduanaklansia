                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-12 col-sm-12 form-group">
                                ...
                                <div class="item form-group">
                                    <label class="col-form-label col-md-3 col-sm-3 label-align" for="kk_anak">No KK</label>
                                    <div class="col-md-9">
                                        <input type="text" id="kk_anak" name="kk_anak" required="required" data-inputmask="'mask' : '9999999999999999'" class="form-control">
                                    </div>
                                </div>
                                <div class="item form-group">
                                ...
                                <div class="item form-group">
                                    <label class="col-form-label col-md-3 col-sm-3 label-align" for="nama_orang_tua">Nama Orang Tua</label>
                                    <div class="col-md-9">
